...
- `src/configs/attack_scenarios.yaml` — HVT 하네스용 압축 정의(vectors·frag_K·detector_q 등). `run_hvt.py --scenario`가 사용한다.
...
# HVT 하네스는 configs/attack_scenarios.yaml을 사용
python src/run_hvt.py --scenario A7
```
