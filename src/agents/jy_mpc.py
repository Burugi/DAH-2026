# jy_mpc — NeuroGuard 방어모델 구조 (원본: neuroguard/agents/mpc.py)
# MPCPolicy — 룩어헤드 예측제어  · 실동작 통합은 본선 구조에서.
# -*- coding: utf-8 -*-
...
from neuroguard.harness import JAM_VECS, actions, adjacency, components
